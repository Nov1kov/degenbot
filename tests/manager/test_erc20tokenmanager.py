...
def test_get_erc20tokens(local_web3_ethereum_archive: web3.Web3):
    set_web3(local_web3_ethereum_archive)
    token_manager = Erc20TokenHelperManager(chain_id=local_web3_ethereum_archive.eth.chain_id)
    token_registry = AllTokens(chain_id=local_web3_ethereum_archive.eth.chain_id)
