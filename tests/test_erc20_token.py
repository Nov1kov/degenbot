...
def test_non_compliant_tokens(local_ethereum_archive_node_web3):
...
def test_erc20token_with_price_feed(local_ethereum_archive_node_web3):
    set_web3(local_ethereum_archive_node_web3)
    Erc20Token(
...
def test_erc20token_functions(local_ethereum_archive_node_web3):
    set_web3(local_ethereum_archive_node_web3)
    weth = Erc20Token(
        address="0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2",
        oracle_address="0x5f4ec3df9cbd43714fe2740f5e3616155c5b8419",
...
def test_per_instance_lru_cache(local_ethereum_archive_node_web3):
    set_web3(local_ethereum_archive_node_web3)
