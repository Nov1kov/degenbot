...
def test_non_compliant_tokens(local_web3_ethereum_archive):
...
def test_erc20token_with_price_feed(local_web3_ethereum_archive):
    set_web3(local_web3_ethereum_archive)
    Erc20Token(
...
def test_erc20token_functions(local_web3_ethereum_archive):
    set_web3(local_web3_ethereum_archive)
    weth = Erc20Token(
        address="0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2",
        oracle_address="0x5f4ec3df9cbd43714fe2740f5e3616155c5b8419",
